  ...
  return (
    <header className="z-[999] relative">
      <motion.div
        ...
        backdrop-blur-[0.5.rem] sm:top-6 sm:h-[3.25rem] sm:w-[36rem]
        sm:rounded-full"
      ...
      >
        ...
        font-medium text-gray-500 sm:w-[initial] sm:flex-nowrap
        sm:gap-5"
        >
          {links.map((link) => (
            <motion.li
              className="h-3/4 flex items-center justufy-center"
              key={link.hash}
